...
```{r animate_map_2, message=FALSE, warning=FALSE, fig.width=6, fig.height=4}
gganimate::animate(
...
```{r anim_points_render, message=FALSE, warning=FALSE, eval=FALSE}
...
The rendering of this animation has been temporarily disabled so that this 
article can be built faster.

```{r animate_raster_map, message=FALSE, warning=FALSE, eval=FALSE}
