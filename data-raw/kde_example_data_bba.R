...
ten_tracks_kde <- ten_tracks %>%
  group_by(track_id) %>%
  hr_tt_kde(levels = c(0.5, 0.95), h = "h_ref_mean", res = 10000)
...
nine_tracks_kde_1 <- nine_tracks %>%
  group_by(track_id) %>%
  hr_tt_kde(levels = c(0.5, 0.95), h = "h_ref_mean", res = 50000)
...
nine_tracks_kde_2 <- nine_tracks %>%
  group_by(track_id) %>%
  hr_tt_kde(levels = c(0.5, 0.95), h = "h_ref_mean", res = 20000)
