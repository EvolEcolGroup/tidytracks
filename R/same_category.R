...
#'
#' `same_category()` takes a factor vector and returns a pairwise similarity
#' matrix indicating whether observations belong to the same category.
#'
#' The returned matrix contains:
#' \itemize{
#'   \item `1` when two observations are in the same category
#'   \item `0` when two observations are in different categories
