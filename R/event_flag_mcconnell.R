...
#' last currently valid point of each track using an endpoint Root Mean Square
#' (RMS):
...
event_flag_mcconnell <- function(
  ...
  # If there are fewer than 2 events, no speed can be computed; nothing to
  # filter.
  if (nrow(x) < 2) {
