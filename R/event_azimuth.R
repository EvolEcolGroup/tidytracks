...
#' azimuths of the same length as the number of events in `x`, with the
#' azimuth for the last event of each track padded with an NA.
#' @param x A move2 object
#' @param units Optional, the units to use for the azimuth. The default is "m".
#' @returns a vector of azimuths of the same length as the number of events in `x`
#' @export
